...
def main():
    ...
    print()
    print("Legend:")
    print("  Diff = Difficulty rating (percentile-based, ~12 characters per bucket)")
    print("         VERY HARD (bottom 20%) | HARD (20-40%) | MEDIUM (40-60%)")
    print("         EASY (60-80%) | VERY EASY (top 20%)")
    print("         Characters with same clue count go in lower (harder) bucket")
    print()
